/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 1c111f51f65b65ad210501642d502468)
// Runtime types generated with workerd@1.20260710.1 2026-07-16 
interface __BaseEnv_Env {
	IMAGES: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	SYSTEM_ADMIN_EMAILS: "62ichiken@gmail.com,ichinose.kenki@tbs.co.jp";
	NUXT_PUBLIC_FIREBASE_API_KEY: string;
	NUXT_PUBLIC_FIREBASE_AUTH_DOMAIN: string;
	NUXT_PUBLIC_FIREBASE_DATABASE_URL: string;
